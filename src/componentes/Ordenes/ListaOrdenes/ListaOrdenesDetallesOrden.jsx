...
export default function ListaOrdenesDetallesOrden({
  ...
  const ValidarFormateoDeFecha = (fecha) => {
    if (fecha) {
      ...
      {paquete.length > 0 ? (
        <>
          ...
          <div className="ListaOrdenesDetallesOrden__Detalles">
            ...
            {paquete[indiceOrden].NombreVerificadorOrden || "N/A"}
          </div>
          <section className="ListaOrdenesDetallesOrden__Seccion">
          ...
          <div className="ListaOrdenesDetallesOrden__Detalles">
            ...
            {ValidarFormateoDeFecha(paquete[indiceOrden].FechaIngresoOrden)}
          </div>
          <div className="ListaOrdenesDetallesOrden__Detalles">
            <ion-icon name="checkmark-circle"></ion-icon> <b>Verificación</b>{" "}
            {ValidarFormateoDeFecha(
              paquete[indiceOrden].FechaVerificacionOrden
            ) || "dd/mm/aaaa"}
          </div>
          <div className="ListaOrdenesDetallesOrden__Detalles">
            <ion-icon name="send"></ion-icon> <b>Envío</b>{" "}
            {ValidarFormateoDeFecha(paquete[indiceOrden].FechaEnvioOrden)}
          </div>
          <div className="ListaOrdenesDetallesOrden__Detalles Recibio">
            <ion-icon name="bag-check"></ion-icon> <b>Recibió</b>{" "}
            {ValidarFormateoDeFecha(paquete[indiceOrden].FechaRecibioOrden)}
          </div>
          <section className="ListaOrdenesDetallesOrden__Seccion">
          ...
          <div className="ListaOrdenesDetallesOrden__Detalles">
            ...
            {ValidarFormateoDeFecha(paquete[indiceOrden].FechaEntregaOrden)}
          </div>
          <div className="ListaOrdenesDetallesOrden__Detalles">
