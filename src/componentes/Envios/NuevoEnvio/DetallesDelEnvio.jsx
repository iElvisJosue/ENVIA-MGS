...
import "../../../estilos/componentes/Envios/NuevoEnvio/DetallesDelEnvio.css";

export default function DetallesDelEnvio({
  detallesPedido,
  establecerVista,
  ...
  return (
    <div className="DetallesDelEnvio">
      {paquete.length > 0 ? (
        <>
          <section className="DetallesDelEnvio__Opciones">
            {ReiniciarRealizarPedido ? (
              <button
                className="DetallesDelEnvio__Opciones--Boton OtroPedido"
              ...
              <button
                className="DetallesDelEnvio__Opciones--Boton Regresar"
                onClick={() => establecerVista(0)}
              >
                <ion-icon name="arrow-back"></ion-icon>
              </button>
            )}
            <span className="DetallesDelEnvio__Opciones--Botones">
              <a
                className="DetallesDelEnvio__Opciones--Boton Ticket"
              ...
              <a
                className="DetallesDelEnvio__Opciones--Boton CodigoDeBarras"
              ...
              {paquete.length > 1 && (
                <a
                  className="DetallesDelEnvio__Opciones--Boton PaqueteTickets"
          ...
          {paquete.length > 1 && (
            <section className="DetallesDelEnvio__OtrosPedidos">
              <small className="DetallesDelEnvio__OtrosPedidos--Texto">
                ¡Se han creado otros {paquete.length - 1} pedidos junto a este!{" "}
                <ion-icon name="documents"></ion-icon>
              </small>
              <div className="DetallesDelEnvio__OtrosPedidos--Botones">
                {indicePedido > 0 && (
                  <button
                    className="DetallesDelEnvio__OtrosPedidos--Botones--Boton Anterior"
                ...
                {indicePedido < paquete.length - 1 && (
                  <button
                    className="DetallesDelEnvio__OtrosPedidos--Botones--Boton Siguiente"
          ...
          <div className="DetallesDelEnvio__Detalles Remitente">
            <p className="DetallesDelEnvio__Detalles__Encabezado">
          ...
          <div className="DetallesDelEnvio__Detalles Destinatario">
            <p className="DetallesDelEnvio__Detalles__Encabezado">
          ...
          <div className="DetallesDelEnvio__Detalles ValorDeclarado">
          ...
          <div className="DetallesDelEnvio__Detalles ValorAsegurado">
          ...
          <div className="DetallesDelEnvio__Detalles TCF">
          ...
          <div className="DetallesDelEnvio__Detalles CostoEnvio">
          ...
          <div className="DetallesDelEnvio__Detalles CostoSeguro">
          ...
          <div className="DetallesDelEnvio__Detalles CostoSobrePeso">
          ...
          <div className="DetallesDelEnvio__Detalles Total">
          ...
          <div className="DetallesDelEnvio__Detalles Movimiento">
            {cargandoMovimientos ? (
              <Cargando />
            ) : (
              <>
                <span className="DetallesDelEnvio__Detalles__Movimiento--Encabezado">
                  <p className="DetallesDelEnvio__Detalles__Movimiento--Encabezado--Descripcion">
                ...
                {movimientos.length > 0 ? (
                  movimientos.map((movimiento, index) => (
                    <span
                      key={index}
                      className={`DetallesDelEnvio__Detalles__Movimiento--Encabezado ${movimiento.EstadoMovimiento}`}
                    >
                      <b className="DetallesDelEnvio__Detalles__Movimiento--Encabezado--Descripcion">
